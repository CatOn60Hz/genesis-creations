...
const Services: React.FC = () => {
  return (
    <section id="services" className="bg-maroon-dark text-cream py-24 px-6">
      ...
      <div className="mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-5 sm:grid-cols-4">
        {areas.map((a) => (
          <div
            key={a.name}
            className="flex flex-col items-center gap-3 rounded-2xl border border-tan/20 bg-cream/5 p-6 text-center transition-colors hover:bg-cream/10"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-tan text-maroon-dark">
              {a.icon}
            </div>
