          ...
          <span key={wordIndex} className="inline-block whitespace-nowrap">
            {word.split("").map((letter) => {
              ...
              const transformedStyles = Object.entries(styles).reduce(
                (acc, [key, value]) => {
                  const v = value as StyleValue<keyof CSSPropertiesWithValues>
                  // eslint-disable-next-line react-hooks/rules-of-hooks
              ...
              return (
                // Letters render immediately (no fade-in). Inner span keeps the
                // cursor-proximity scale/color transforms.
                <motion.span
