...
export const TestimonialSlider = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-[560px] md:min-h-[500px] overflow-hidden bg-background text-foreground p-6 md:p-10",
        className
      )}
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full">
        ...
        <div className="md:col-span-4 relative h-80 min-h-[360px] md:min-h-[420px] order-1 md:order-2">
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
          ...
          <div className="flex items-center space-x-2 mt-8 md:mt-0">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-12 h-12 border-foreground/40"
              onClick={handlePrev}
